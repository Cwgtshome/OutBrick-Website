...
export type HomeCopy = {
  ...
  apple: {
    ...
    lede: string;
    platforms: string;
    showcase: { label: string; ipad: string; iphone: string; iphone2: string };
...
const en: HomeCopy = {
  ...
  apple: {
    ...
    showcase: {
      ...
      ipad: 'OutBrick on iPad: the home screen, with Peach, Bloo and Sprout standing in front of a brick village.',
      iphone: 'OutBrick on iPhone: a packed board at level 214, with coloured gates around its frame.',
      iphone2: 'OutBrick on iPhone: the Collection of brick cards, Bloo and Peach in their everyday, cheering, thinking, gold, night and candy looks.',
    },
    widgets: {
      tag: 'Lock Screen',
...
const fr: HomeCopy = {
  ...
  apple: {
    ...
    showcase: {
      ...
      ipad: 'OutBrick sur iPad : l’écran d’accueil, avec Peach, Bloo et Sprout devant un village de briques.',
      iphone: 'OutBrick sur iPhone : un plateau bien rempli au niveau 214, entouré de portes de couleur.',
      iphone2: 'OutBrick sur iPhone : la Collection de cartes briques, avec Bloo et Peach dans toutes leurs tenues.',
    },
    widgets: {
...
const de: HomeCopy = {
  ...
  apple: {
    ...
    showcase: {
      ...
      ipad: 'OutBrick auf dem iPad: der Startbildschirm mit Peach, Bloo und Sprout vor einem Dorf aus Steinen.',
      iphone: 'OutBrick auf dem iPhone: ein prall gefülltes Spielfeld in Level 214, mit farbigen Toren am Rahmen.',
      iphone2: 'OutBrick auf dem iPhone: die Sammlung der Steinkarten, mit Bloo und Peach in all ihren Varianten.',
    },
    widgets: {
      tag: 'Sperrbildschirm',
...
const es: HomeCopy = {
  ...
  apple: {
    ...
    showcase: {
      ...
      ipad: 'OutBrick en iPad: la pantalla de inicio, con Peach, Bloo y Sprout delante de un pueblo de ladrillos.',
      iphone: 'OutBrick en iPhone: un tablero lleno en el nivel 214, con puertas de colores alrededor del marco.',
      iphone2: 'OutBrick en iPhone: la Colección de cartas de ladrillo, con Bloo y Peach en todas sus versiones.',
    },
    widgets: {
...
const ja: HomeCopy = {
  ...
  apple: {
    ...
    showcase: {
      ...
      ipad: 'iPad の OutBrick：ブロックの村の前に Peach、Bloo、Sprout が並ぶホーム画面。',
      iphone: 'iPhone の OutBrick：色つきのゲートに囲まれた、レベル 214 のぎっしり詰まったステージ。',
      iphone2: 'iPhone の OutBrick：ブロックカードのコレクション。いろいろな姿の Bloo と Peach。',
    },
    widgets: {
      tag: 'ロック画面',
