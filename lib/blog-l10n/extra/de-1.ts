    ...
    sections: {
      ...
      'knowing-when-to-step-away': {
        ...
        paragraphs: [
          ...
          'Abstand nehmen fällt leichter, wenn das Spiel dich nicht dafür bestraft. Auf einem OutBrick-Feld läuft keine Zeit: Das Limit jedes Feldes zählt Züge, nicht Sekunden, du kannst also das Handy weglegen und nachdenken, ohne dass irgendetwas herunterzählt. Das [Feld des Tages](/daily) bleibt den ganzen Tag gleich und eignet sich deshalb bestens für einen zweiten Blick nach dem Mittagessen.',
    ...
    sections: {
      ...
      'perseverance-without-the-grind': {
        ...
        paragraphs: [
          ...
          'OutBrick ist so gebaut, dass Durchhalten nicht viel kostet. Es gibt keine Uhr, die erste Zugrücknahme auf jedem Feld ist kostenlos, und ein Leben geht nur verloren, wenn ein Versuch ohne Lösung endet, nie für das Öffnen oder Lösen eines Feldes. Die vollständigen Bedingungen stehen in der [Fair-Play-Übersicht auf der Startseite](/#fair). Alle 2.000 Felder wurden vor der Veröffentlichung von einem Solver gelöst, ein Feld, das unmöglich aussieht, hat also einen Weg hindurch. Das [Feld des Tages](/daily) ist ein guter Ort zum Üben: Es bleibt den ganzen Tag gleich, und wenn es sich beim Frühstück sträubt, wartet es später immer noch auf dich.',
        ],
      },
    },
