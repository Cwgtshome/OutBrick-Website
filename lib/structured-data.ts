...
export function websiteNode(): Node {
  return {
    ...
    // TODO: add a SearchAction `potentialAction` once the journal has a working search URL
    // (e.g. /blog?q={search_term_string} answering from the static build). None exists yet,
    // and Google asks for the action only when the URL really returns results.
  };
}
