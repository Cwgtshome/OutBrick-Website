...
export const articles: BlogArticle[] = [
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'Undo is part of the loop rather than a punishment for using it, which is why every board carries one that is free and cannot run out. That changes the emotional temperature of experimentation. You can try a move, learn from the result, and keep the useful part of the attempt. The goal is not to make every board effortless; it is to make curiosity safer than hesitation.',
        ],
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          'OutBrick’s promise is simple: give the player a board worth thinking about, then give the player their time back. That means nothing plays between moves that the player did not press a button to see, a mistake that costs at most one undo the board already gave them for free, and no requirement to keep the app open for the game to remain interesting — the lives tank refills whether you are watching it or not.',
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'The design insight is still valuable: a game world becomes stronger when its surrounding touchpoints feel like the same world. OutBrick uses mascots, widgets, a daily coin bonus, and a calm visual language as invitations back into the board—not as separate products competing for attention.',
        ],
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'That is different from adding noise. OutBrick’s chapters, star meters, widgets, and mascots are meant to orbit the same core action: slide a brick into the right place. Each layer should give the move a new context without asking the player to learn a second game.',
        ],
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'The point is not that every game needs a 3D printer. It is that play becomes stickier when it leaves behind something that feels like yours. In OutBrick, a cleared chapter, a favourite mascot, or a third star on a board you went back for can work as a small personal trace: a reminder of a moment rather than a demand for another one.',
        ],
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'There is one cost worth stating plainly rather than burying: walking away from a board you have already moved on spends one of your five lives, and one life comes back on its own every thirty minutes. That is the genre’s rule and we kept it, because without it a move limit means nothing. Nothing else spends one — not playing, not clearing, not undoing, not opening a level to look at it and changing your mind. We also keep the game visually calm and the core session legible. The goal is to make “one more board” a choice, not a trap hidden inside the interface.',
        ],
  ...
  },
  {
    ...
    title: 'From Stardew Valley to cozy play: designing for gentle progress',
    ...
    intro: 'Cozy play is not a genre checklist. It is a relationship with time. The player can see what they are growing, choose the pace of the next task, and feel that returning is a pleasure rather than a debt.',
    keyTakeaways: [
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'For OutBrick, that means a board can be kind without being solved for you. The rules stay firm, the answer is earned, and undo keeps an experiment from becoming a punishment. The player gets a small problem with a clear edge, not a blank screen disguised as relaxation.',
        ],
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'That is the part OutBrick wants to make its own: a board that meets you where you are, a little progress that remains yours, and an experience that never confuses pressure with care.',
        ],
        sourceIds: ['gaming-fit-2025', 'time-wellbeing-2022'],
      },
    ],
    ...
    sections: [
      {
        ...
        paragraphs: [
          ...
          'The loop is easy to translate: release a coherent slice, listen to what players can actually understand, then make the next slice answer a better question. Feedback is not a vote on every detail. It is evidence about where the design is communicating and where it is asking players to guess.',
        ],
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'The OutBrick board is small enough for the player to hold in memory. A failed line can become a clue, not a scar. That is the whole point of a compact loop: less content to forget, more meaning in the decision that remains.',
        ],
  ...
  },
  {
    ...
    sections: [
      {
        ...
        paragraphs: [
          ...
          'The design distinction matters. A support option is not a second-class version of the game. It is an invitation to choose the conditions under which the player can participate in the idea the game cares about.',
        ],
      ...
      },
      {
        ...
        paragraphs: [
          'The W3C advises that color should not be the only visual means of conveying information. Microsoft’s game accessibility guidance makes a related case for pairing signals and considering play without sound, on a monochrome display, or after a long break.',
          'In OutBrick, shapes, studs, spacing, contrast, and motion reinforce the color language. The result is better for players who cannot use hue reliably, but it is also better for everyone when the board explains itself at a glance.',
        ],
        sourceIds: ['w3c-color', 'microsoft-game-accessibility'],
      },
      {
        ...
        paragraphs: [
          ...
          'That is the standard OutBrick is aiming for. A kinder difficulty curve, a clear recovery path, and a color-blind mode are not decorations around the puzzle. They help the puzzle remain the puzzle for more people.',
        ],
        bullets: ['Pair color with shape and pattern', 'Keep support options reversible and visible', 'Test with players who use the options', 'Treat unconventional play as valid play'],
    ...
    faqs: [
      ...
      { question: 'What accessibility options does OutBrick have?', answer: 'OutBrick reinforces color with shapes and glyphs and includes a color-blind mode. We continue to treat player feedback and testing as part of the work.' },
    ],
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'That sentence is enough to create ownership. The board is not merely presenting an answer; it is giving the player a sequence of decisions they can remember as theirs.',
        ],
  ...
  },
  {
    ...
    sections: [
      {
        ...
        paragraphs: [
          'Wang and Hsieh’s study of Pokémon GO examines the relationship between people, environments, and a location-based augmented-reality game. That framing is useful because the game’s novelty is not only the collection system; it is the way familiar geography becomes actionable. A corner, trail, or public space can acquire a new affordance when play points your attention toward it.',
      ...
      },
      {
        ...
        paragraphs: [
          'OutBrick does not ask you to walk around with your phone open. Its place is the small interval: the train platform, the coffee table, the minute before a meeting. The connection is philosophical rather than mechanical. A good game can make an ordinary context feel more intentional by giving attention a clear, bounded shape.',
    ...
    relatedSlugs: ['animal-crossing-shared-time', 'designing-for-real-life-play', 'daily-rituals-that-dont-demand-you'],
  },
  {
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          'OutBrick is intentionally not a social feed. Still, a puzzle can become a shared object when someone explains the bottleneck, sends a screenshot of a clear, or asks a friend how they read the same shape. The board is a small place for interpretation.',
    ...
    sections: [
      {
        ...
        paragraphs: [
          ...
          'That is the trick. A rule becomes expressive when the player understands both what the system asks and what the choice costs. The game does not need a long speech before every decision; the tension lives in the relationship between the checklist and the person standing in front of it.',
        ],
      ...
      },
      {
        ...
        paragraphs: [
          'A meaningful constraint creates a conflict the player can name. Accuracy may protect a job, speed may protect a family, and strictness may protect one person while harming another. The point is not that the game offers a single correct moral answer; it is that the system lets the player feel the collision between values.',
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'The interface should not add arbitrary pain to that decision. The challenge belongs in the spatial relationship, not in a hidden timer, unclear icon, or scarce undo. That distinction is the line between friction that produces thought and friction that merely consumes patience.',
        ],
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          'OutBrick’s intended loop is deliberately plain. A familiar context opens the app, a board presents one question, the player makes a move, and the clear provides a natural pause. The Journey keeps generating boards past its two thousandth for a player who wants more, but that does not swallow the meaning of the chapters behind it.',
  ...
  },
  {
    ...
    intro: 'The commuter puzzle is not a smaller console game. It has a different contract with attention: make the state clear quickly, respect interruption, and make two minutes feel complete rather than unfinished.',
    keyTakeaways: [
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'The result is not productivity disguised as play. It is simply a small game that understands the shape of a real day—and gives the player permission to enjoy the gap without asking the gap to become something bigger.',
        ],
    ...
    relatedSlugs: ['why-two-minute-puzzles-feel-good', 'designing-for-real-life-play', 'how-games-become-habits'],
    faqs: [
      { question: 'How long is an OutBrick board?', answer: 'The core is designed to fit a short pause, but completion time varies with the board and the player. There is no timer in the main journey — what a board limits is moves, not minutes, so thinking for as long as you like is free.' },
