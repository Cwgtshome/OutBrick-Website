...
export const articles: BlogArticle[] = [
  ...
  },
  {
    ...
    readingTime: '8 min read',
    authorId: 'mourad-hamdi',
    image: '/blog/games-teaches-curiosity-without-a-lecture.png',
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          'OutBrick’s intended loop is deliberately plain. A familiar context opens the app, a board presents one question, the player makes a move, and the clear provides a natural pause. Endless mode exists for a player who wants more, but it does not swallow the meaning of the main journey.',
    ...
    faqs: [
      ...
      { question: 'Why does OutBrick use daily play at all?', answer: 'A daily board gives the game a small, optional rhythm. It is an invitation with a clear endpoint, not a streak that turns absence into failure.' },
    ],
  },
  {
    ...
    keyTakeaways: [
      ...
      'OutBrick treats interruption as a normal condition, with readable state, undo, and no requirement to defend a fragile run.',
    ],
    sections: [
      {
      ...
      },
      {
        ...
        paragraphs: [
          'OutBrick is built for the gap between obligations. The board can be read quickly, a move can be undone without cost, and completion does not require a long chain of setup. If the train arrives or the coffee is ready, the player can leave with the board’s state intact.',
    ...
    faqs: [
      { question: 'How long is an OutBrick board?', answer: 'The core is designed to fit a short pause, but completion time varies with the board and the player. There is no timer in the main journey.' },
      { question: 'Can I leave a board unfinished?', answer: 'Yes. OutBrick is designed to preserve your place and make returning understandable, so interruption does not turn play into a loss.' },
    ],
  },
];
