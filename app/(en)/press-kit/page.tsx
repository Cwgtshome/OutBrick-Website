    ...
    <EditorialPage current="press-kit">
      ...
      <section id="friends" className="ed-band-cream ed-band" aria-labelledby="friends-title" style={{ scrollMarginTop: 70 }}>
        <div className="ed-wrap">
          ...
          <h2 id="friends-title" className="ed-h2" style={{ marginTop: 14 }}>The app icon, the wordmark and all nine friends.</h2>
          ...
          <div className="ed-downloads">
            ...
            <a className="ed-download" href="/assets/logo/outbrick-wordmark.png" download="outbrick-wordmark.png">
              <span className="plinth icon wordmark"><img src="/assets/logo/outbrick-wordmark-192.webp" alt="" width={978} height={192} loading="lazy" decoding="async" /></span>
              <b>Wordmark</b>
              <span>PNG, transparent, 881 × 173</span>
            </a>
            {friends.map((friend) => (
              <a
