      ...
      <main className="press-kit-main" aria-labelledby="press-kit-title">
        <section className="press-kit-hero">
          <div className="press-kit-hero-copy">
            ...
            <p>OutBrick is a daily puzzle ritual built for focus, play, and progress. This press kit has the assets, screens, and short version of the game ready to share.</p>
        ...
        <section className="press-kit-story" aria-labelledby="press-kit-story-title">
          ...
          <div className="press-kit-story-copy">
            ...
            <div className="press-kit-facts"><span><strong>Format</strong> iPhone + iPad game</span><span><strong>Feel</strong> Calm, tactile, readable</span><span><strong>Promise</strong> No ads. No lives.</span></div>
          </div>
        </section>
