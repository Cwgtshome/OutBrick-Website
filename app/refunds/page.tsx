...
export default function RefundsPage() {
  return (
    ...
    >
      ...
      <p>For an eligible non-consumable purchase — Remove Ads, a Brick Pass, or a wardrobe item — open OutBrick › Shop › Restore purchases. Make sure the device is using the Apple Account that made the purchase. Consumable items such as coin packs generally cannot be restored after they have been consumed.</p>
