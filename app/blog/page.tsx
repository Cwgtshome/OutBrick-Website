...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    title,
    description,
    images: [{ url: `${siteUrl}${articles[0]!.image}`, width: 1672, height: 941, alt: articles[0]!.imageAlt }],
  },
  twitter: {
          ...
          <div className="ed-feature" data-tone={featured.categoryColor} style={{ marginTop: 26 }}>
            ...
            <div className="ed-feature-art ed-reveal">
              <figure className="ed-frame">
                <img src={featured.image} alt={featured.imageAlt} width={1672} height={941} decoding="async" fetchPriority="high" />
