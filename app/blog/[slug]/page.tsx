...
export async function generateMetadata({ params }: ArticlePageProps): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      ...
      tags: article.tags,
      images: [{ url: image, width: 1672, height: 941, alt: article.imageAlt }],
    },
    twitter: {
...
export default async function ArticlePage({ params }: ArticlePageProps) {
  ...
  const postingData = {
    ...
    description: article.dek,
    image: { '@type': 'ImageObject', url: `${siteUrl}${article.image}`, width: 1672, height: 941 },
          ...
          <div className="ed-wrap">
            ...
            <div className="ed-ahead-grid">
              ...
              <figure className="ed-frame">
                <img src={article.image} alt={article.imageAlt} width={1672} height={941} decoding="async" fetchPriority="high" />
