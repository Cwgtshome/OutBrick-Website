  ...
  return (
    <li className="ed-row" data-tone={article.categoryColor}>
      ...
      <div className="ed-thumb" aria-hidden="true">
        <img src={article.image} alt="" width={1672} height={941} loading={eager ? 'eager' : 'lazy'} decoding="async" />
      </div>
    </li>
  );
}
  ...
  return (
    <article className="ed-card ed-lift" data-tone={article.categoryColor}>
      ...
      <div className="ed-card-body">
        <div className="ed-thumb" aria-hidden="true">
          <img src={article.image} alt="" width={1672} height={941} loading="lazy" decoding="async" />
        </div>
