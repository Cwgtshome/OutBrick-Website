...
export default function AccessibilityPage() {
  return (
    ...
    >
      ...
      <p>The game adapts its layouts for iPhone and iPad. Play is touch-first, with one-finger brick movement and a free Undo action. If a control is clipped, hard to reach, or not announced as expected, please include the device model, iOS version, and the name of the affected screen.</p>
