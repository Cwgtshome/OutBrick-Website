...
/**
 * The /play board, which also honours `?board=N` (1-based). The page is a
...
export function PlayBoard({ label }: { label: string }) {
  ...
  return <PlayableBoard key={level} startLevel={level} label={label} />;
}
