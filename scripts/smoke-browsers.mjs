...
const paths = ['/', '/ja', '/de/play', '/play', '/blog', '/blog/how-to-solve-sliding-block-puzzles', '/mascots', '/support', '/play/result/2-3', '/contact', '/affiliates', '/careers', '/careers/ai-ml-engineer', '/press'];
const targets = [
