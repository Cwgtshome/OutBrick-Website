...
const paths = ['/', '/ja', '/de/play', '/play', '/blog', '/blog/how-to-solve-sliding-block-puzzles', '/mascots', '/support', '/play/result/2-3', '/contact', '/affiliates', '/careers', '/careers/ai-ml-engineer', '/press', '/c/42?par=18'];
const targets = [
